              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id='demo-form2' action='<?php echo base_url('Dashboard/UpdateProfileDo')?>' method='post' class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <img src="<?php echo base_url('assets/uploads/ProfilePhoto/default.jpg')?>" width="150px"/>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="file" id="telephone" name="file"  class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
